...
function eu(e, n, t, r) {
  if (Dr) {
    var l = fo(e, n, t, r);
    if (l === null) Dl(e, n, r, Fr, t), Zu(e, r);
...
function Ef(e, n) {
  if (Fn)
    return e === "compositionend" || (!lu && Fs(e, n))
      ? ((e = Is()), (kr = nu = nn = null), (Fn = !1), e)
      : null;
  switch (e) {
    case "paste":
      return null;
  ...
  if (!e[cr]) {
    (e[cr] = !0),
      rs.forEach(function (t) {
        t !== "selectionchange" && (Df.has(t) || Il(t, !1, e), Il(t, !0, e));
      });
...
function xo(e, n, t, r) {
  var l = e.stateNode;
  (l.props = t), (l.state = e.memoizedState), (l.refs = la), pu(e);
  var o = n.contextType;
  typeof o == "object" && o !== null
    ? (l.context = _e(o))
...
function $a(e) {
  ...
  n !== null && ((e.alternate = null), $a(n)),
    ...
    e.tag === 5 &&
      ((n = e.stateNode),
      n !== null &&
        (delete n[Fe], delete n[Vt], delete n[wo], delete n[Vf], delete n[Bf])),
    (e.stateNode = null),
    (e.return = null),
    (e.dependencies = null),
...
function Wa(e, n) {
  ...
  if (n !== 0) {
    if (
      ...
      throw ((t = Yt), _n(e, 0), en(e, r), de(e, W()), t);
    if (n === 6) en(e, r);
    else {
      if (
      ...
      switch (((e.finishedWork = l), (e.finishedLanes = r), n)) {
        ...
        case 3:
          if (
            ...
            e.timeoutHandle = go(Sn.bind(null, e, se, $e), n);
            break;
          }
          Sn(e, se, $e);
          break;
        case 4:
          ...
          if (
            ...
            e.timeoutHandle = go(Sn.bind(null, e, se, $e), r);
            break;
          }
          Sn(e, se, $e);
          break;
...
function Vi(e) {
  ...
  if (t === 1) throw ((t = Yt), _n(e, 0), en(e, n), de(e, W()), t);
...
function Xa(e, n) {
  ...
  var t = oe();
  (e = Ye(e, n)), e !== null && (Xt(e, n, t), de(e, t));
}
function pd(e) {
  var n = e.memoizedState,
    t = 0;
...
function Sd(e, n, t, r, l) {
  ...
  var s = Tu(e, 0, !1, null, null, !1, !1, "", Wi);
  return (
  ...
  switch (e.tag) {
    case 3:
      ...
      if (n.current.memoizedState.isDehydrated) {
        ...
        t !== 0 &&
          (qo(n, t | 1), de(n, W()), (R & 6) === 0 && ((lt = W() + 500), hn()));
      }
      break;
    case 13:
      Tn(function () {
...
ys = Nu;
gs = Tn;
var kd = { usingClientEntryPoint: !1, Events: [Jt, $n, ll, vs, hs, Nu] },
  yt = {
...
const Iu = vl.exports.Fragment,
  ...
  Td = ({ onNewCategory: e }) => {
    ...
    return Du(Iu, {
      children: [
        ve("div", {
          className: "logo",
          children: ve("img", { src: Cd, alt: "logo" }),
        }),
        ve("form", {
          onSubmit: (o) => {
  ...
  Md = ({ title: e, url: n, id: t }) =>
    Du("div", {
      className: "card",
      children: [ve("img", { src: n, alt: e }), ve("p", { children: e })],
    }),
  Id = ({ category: e }) => {
  ...
  Dd = () => {
    ...
    return Du(Iu, {
      children: [
        ve(Td, { onNewCategory: (r) => t(r) }),
        e.map((r) => ve(Id, { category: r }, r)),
      ],
    });
  };
Kl.createRoot(document.getElementById("root")).render(
  ve(wc.StrictMode, { children: ve(Dd, {}) })
);
