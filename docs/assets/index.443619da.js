...
function Yu(e) {
  if ((e = Jt(e))) {
    ...
    var n = e.stateNode;
    n && ((n = ll(n)), io(e.stateNode, e.type, n));
  }
}
function vs(e) {
...
function hs() {
  if (Yn) {
    var e = Yn,
      n = Gn;
    if (((Gn = Yn = null), Yu(e), n)) for (e = 0; e < n.length; e++) Yu(n[e]);
  }
}
function ys(e, n) {
  return e(n);
...
function nu(e, n, t, r) {
  if (Dr) {
    var l = po(e, n, t, r);
    if (l === null) Fl(e, n, r, Fr, t), Zu(e, r);
    else if (Kc(l, e, n, t, r)) r.stopPropagation();
    else if ((Zu(e, r), n & 4 && -1 < Qc.indexOf(e))) {
      for (; l !== null; ) {
        var o = Jt(l);
        if (
          (o !== null && zs(o),
          (o = po(e, n, t, r)),
          o === null && Fl(e, n, r, Fr, t),
          o === l)
        )
          break;
        l = o;
...
var Sf = Qe && "TextEvent" in window && !_t,
  Ds = Qe && (!ou || (_t && 8 < _t && 11 >= _t)),
...
function As(e) {
  if (e.propertyName === "value" && tl(jt)) {
    var n = [];
    Us(n, jt, e, Jo(e)), ws(_f, n);
  }
}
function Nf(e, n, t) {
  e === "focusin"
    ? (ui(), (xt = n), (jt = t), xt.attachEvent("onpropertychange", As))
    : e === "focusout" && ui();
}
function Pf(e) {
...
for (var Ml = 0; Ml < ci.length; Ml++) {
  var Il = ci[Ml],
    Mf = Il.toLowerCase(),
    If = Il[0].toUpperCase() + Il.slice(1);
  mn(Mf, "on" + If);
}
      ...
      N &&
        (Ds &&
          ...
          (Fn || N !== "onCompositionStart"
            ? N === "onCompositionEnd" && Fn && (x = Is())
            : ((nn = v),
              (tu = "value" in nn ? nn.value : nn.textContent),
              (Fn = !0))),
        (_ = jr(c, N)),
        0 < _.length &&
          ((N = new ei(N, e, null, t, v)),
...
var wo = typeof setTimeout == "function" ? setTimeout : void 0,
  ...
  $f =
    typeof queueMicrotask == "function"
      ...
      : typeof mi < "u"
      ? function (e) {
          return mi.resolve(null).then(e).catch(Af);
        }
      : wo;
function Af(e) {
  setTimeout(function () {
...
function hn() {
  if (!Ul && Ae !== null) {
    ...
    try {
      ...
      throw (Ae !== null && (Ae = Ae.slice(e + 1)), Cs(qo, hn), l);
    } finally {
      (O = n), (Ul = !1);
    }
  }
...
function No(e, n, t, r) {
  var l = e.stateNode;
  (l.props = t), (l.state = e.memoizedState), (l.refs = la), mu(e);
  var o = n.contextType;
  typeof o == "object" && o !== null
    ? (l.context = _e(o))
    : ((o = de(n) ? Nn : re.current), (l.context = bn(e, o))),
...
function wu(e, n, t, r, l, o) {
  if (
    ...
    (n.updateQueue = null),
    (n.lanes = 0),
    (_r.current = e === null || e.memoizedState === null ? Xf : Zf),
    (e = t(r, l)),
    Pt)
  ) {
    o = 0;
...
function Lo(e, n, t, r, l, o) {
  Oa(e, n);
  var u = (n.flags & 128) !== 0;
  if (!r && !u) return l && yi(n, t, !1), Ge(e, n, o);
...
function Mi(e, n, t, r, l) {
  return et(), au(l), (n.flags |= 256), le(e, n, t, r), n.child;
}
...
function $a(e) {
  ...
  n !== null && ((e.alternate = null), $a(n)),
    ...
    e.tag === 5 &&
      ((n = e.stateNode),
      n !== null &&
        (delete n[Fe], delete n[Vt], delete n[So], delete n[Vf], delete n[Bf])),
    (e.stateNode = null),
    (e.return = null),
    (e.dependencies = null),
...
function pe(e, n) {
  ...
  if (r === 0)
    ...
    if ((t != null && Xu(t), n === 1))
      e.tag === 0 ? Hf(Vi.bind(null, e)) : qs(Vi.bind(null, e)),
        $f(function () {
          (R & 6) === 0 && hn();
        }),
        (t = null);
...
function Wa(e, n) {
  ...
  if (n !== 0) {
    if (
      ...
      throw ((t = Yt), _n(e, 0), en(e, r), pe(e, W()), t);
    if (n === 6) en(e, r);
    else {
      if (
      ...
      switch (((e.finishedWork = l), (e.finishedLanes = r), n)) {
        ...
        case 3:
          if (
            ...
            e.timeoutHandle = wo(Sn.bind(null, e, se, $e), n);
            break;
          }
          Sn(e, se, $e);
          break;
        case 4:
          ...
          if (
            ...
            e.timeoutHandle = wo(Sn.bind(null, e, se, $e), r);
            break;
          }
          Sn(e, se, $e);
          break;
...
function Xa(e, n) {
  ...
  var t = oe();
  (e = Ye(e, n)), e !== null && (Xt(e, n, t), pe(e, t));
}
function pd(e) {
  var n = e.memoizedState,
    t = 0;
...
Za = function (e, n, t) {
  ...
  else (ae = !1), j && (n.flags & 1048576) !== 0 && bs(n, Br, n.index);
      ...
      e: {
        ...
        if (((r = u.element), o.isDehydrated))
          if (
            ...
            (l = rt(Error(y(423)), n)), (n = Mi(e, n, r, t, l));
            break e;
          } else if (r !== l) {
            (l = rt(Error(y(424)), n)), (n = Mi(e, n, r, t, l));
            break e;
          } else
            for (
...
dl.prototype.render = Mu.prototype.render = function (e) {
  var n = this._internalRoot;
  if (n === null) throw Error(y(409));
  fl(e, n, null, null);
};
dl.prototype.unmount = Mu.prototype.unmount = function () {
...
ys = Pu;
gs = Tn;
var kd = { usingClientEntryPoint: !1, Events: [Jt, $n, ll, vs, hs, Pu] },
  yt = {
...
const Cd = "./assets/logo.2ed06724.svg";
var vl = { exports: {} },
  hl = {};
/**
 * @license React
...
const Du = vl.exports.Fragment,
  ce = vl.exports.jsx,
  yl = vl.exports.jsxs,
  Td = ({ onNewCategory: e }) => {
    const [n, t] = He.exports.useState(""),
      r = ({ target: o }) => t(o.value);
    return yl(Du, {
      children: [
        ce("div", {
          className: "logo",
          children: ce("img", { src: Cd, alt: "logo" }),
        }),
        ce("form", {
          onSubmit: (o) => {
            o.preventDefault(), !(n.trim().length <= 1) && (e(n.trim()), t(""));
          },
          children: ce("input", {
            type: "text",
  ...
  Rd = async (e) => {
    const n = `https://api.giphy.com/v1/gifs/search?api_key=ed6q8Fsm6HWCphjUnsyvMZzJnNhq1KEM&q=${e}&limit=10`,
      t = await fetch(n),
      { data: r } = await t.json();
    return r.map((o) => ({
      id: o.id,
  ...
  Od = (e) => {
    const [n, t] = He.exports.useState([]),
      [r, l] = He.exports.useState(!0),
      o = async () => {
        const u = await Rd(e);
        t(u), l(!1);
      };
    return (
      He.exports.useEffect(() => {
        o();
      }, []),
      { images: n, isLoading: r }
    );
  },
  Md = ({ title: e, url: n, id: t }) =>
    yl("div", {
      className: "card",
      children: [ce("img", { src: n, alt: e }), ce("p", { children: e })],
    }),
  Id = ({ category: e }) => {
    const { images: n, isLoading: t } = Od(e);
    return (
      console.log({ isLoading: t }),
      yl(Du, {
        children: [
          ce("div", {
            className: "items",
            children: n.map((r) => ce(Md, { ...r }, r.id)),
          }),
          ce("h5", {}),
          ce("button", {
  ...
  Dd = () => {
    const [e, n] = He.exports.useState(["lucas", "ivan"]);
    function t(r) {
      e.includes(r) || n([r, ...e]);
    }
    return yl(Du, {
      children: [
        ce(Td, { onNewCategory: (r) => t(r) }),
        e.map((r) => ce(Id, { category: r }, r)),
      ],
    });
  };
Yl.createRoot(document.getElementById("root")).render(
  ce(wc.StrictMode, { children: ce(Dd, {}) })
);
